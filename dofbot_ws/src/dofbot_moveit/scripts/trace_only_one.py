...
##
## 맨 처음은 가장 가까이 있는 객체를 타겟으로 선정
## 타겟으로 지정한 단일 객체를 놓치지 않고 계속해서 쫓아야 함 
##
...
from std_msg.msg import UInt32
...
def objects_callback(msg: ObjectsStamped):
	...
	pub = rospy.Publisher('target_object', Object, queue_size=1)
	obj = Object()
...
if __name__ == '__main__':
	rospy.init_node('trace_only_one')
