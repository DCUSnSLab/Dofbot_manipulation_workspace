...
class BoundingBoxesDesign:
    ...
    def make_bounding_box(self, obj: list, obj_index: int) -> MarkerArray:
        bounding_box = Marker()
        # 직육면체의 변의 길이를 계산합니다.
        width = float(obj.bounding_box_3d.corners[0].kp[0] - obj.bounding_box_3d.corners[1].kp[0])
        height = float(obj.bounding_box_3d.corners[2].kp[1] - obj.bounding_box_3d.corners[1].kp[1])
        verticality = float(obj.bounding_box_3d.corners[1].kp[2] - obj.bounding_box_3d.corners[5].kp[2])

        # 직육면체의 중점 좌표를 계산합니다.
        x = float((obj.bounding_box_3d.corners[0].kp[0] + obj.bounding_box_3d.corners[1].kp[0]) / 2)
        y = float((obj.bounding_box_3d.corners[1].kp[1] + obj.bounding_box_3d.corners[2].kp[1]) / 2)
        z = float((obj.bounding_box_3d.corners[5].kp[2] + obj.bounding_box_3d.corners[1].kp[2]) / 2)
        ...
        bounding_box.lifetime.secs = 0.1
    ...
    def print_bounding_box_coord_info(self, turn_on: bool, obj: list, obj_index: int):
        ...
        print("*      1 ------- 2 ({0:.1f}, {1:.1f}, {2:.1f})".format(obj.bounding_box_3d.corners[2].kp[0], obj.bounding_box_3d.corners[2].kp[1], obj.bounding_box_3d.corners[2].kp[2]))
        print("*     /.        /|")
        print("*    0 ------- 3 | ({0:.1f}, {1:.1f}, {2:.1f})".format(obj.bounding_box_3d.corners[3].kp[0], obj.bounding_box_3d.corners[3].kp[1], obj.bounding_box_3d.corners[3].kp[2]))
        print("*    | .       | |")
        print("*    | 5.......| 6 ({0:.1f}, {1:.1f}, {2:.1f})".format(obj.bounding_box_3d.corners[6].kp[0], obj.bounding_box_3d.corners[6].kp[1], obj.bounding_box_3d.corners[6].kp[2]))
        print("*    |.        |/")
        print("*    4 ------- 7")
        print("*    ({0:.1f}, {1:.1f}, {2:.1f})".format(obj.bounding_box_3d.corners[4].kp[0], obj.bounding_box_3d.corners[4].kp[1], obj.bounding_box_3d.corners[4].kp[2]))
