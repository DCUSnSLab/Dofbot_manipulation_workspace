...
class garbage_identify:
    def __init__(self):
        ...
        self.anchors_path = '/home/dofbot/catkin_ws/src/arm_garbage_identify/model_data/yolo_anchors.txt'
        self.classes_path = '/home/dofbot/catkin_ws/src/arm_garbage_identify/model_data/garbage.txt'
        self.model_path = '/home/dofbot/catkin_ws/src/arm_garbage_identify/model_data/garbage.h5'
        self.font_path = '/home/dofbot/catkin_ws/src/arm_garbage_identify/font/Block_Simplified.TTF'
...
#                 (a, b) = (round(((x - 320) / 4000), 5), round(((240 - y) / 3000 + 0.265) * 0.95, 5))
    ...
    def garbage_run(self, img):
        ...
        if self.garbage_index >= 3:
            ...
            try: img, msg = self.detect_image(img)  
